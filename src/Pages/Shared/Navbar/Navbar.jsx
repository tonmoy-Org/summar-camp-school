        ...
        <div className="navbar fixed z-10 lg:px-10 bg-[#F4F4EC] h-0 pe-5">
            ...
            <div className="navbar hidden lg:flex justify-center">
                <ul className="px-4 gap-10 font-semibold">
                    ...
                    <li><Link to={isAdmin?.admin ? '/dashboard/adminHome' : isInstructor?.instructor ? '/dashboard/myClass' : '/dashboard/studentClass'}>Dashboard</Link ></li>
                </ul>
            </div>
                    ...
                    <div tabIndex={0} className="mt-3 p-2 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow">
                        <div className="card-body">
                            ...
                            <div className="card-actions">
                                <Link to='/dashboard/studentClass'><button className="btn btn-sm btn-primary btn-block">View cart</button></Link>
